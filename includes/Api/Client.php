 ...
 *
 * Runs on PHP 8.0 with no bundled HTTP client, rather than on the billto/billto-php SDK, which
 * requires PHP 8.2 and PSR-18. Provides Bearer auth, an Idempotency-Key on every mutation, one
 * retry for transient failures and typed errors.
 */
class Client
{
